...
public class Cadastro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnCriarBanco = new javax.swing.JToggleButton();
        ...
        btnCriarBanco.setBackground(new java.awt.Color(204, 204, 204));
        btnCriarBanco.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        btnCriarBanco.setForeground(new java.awt.Color(204, 51, 255));
        btnCriarBanco.setText("Criar BD");
        btnCriarBanco.setName("btnCriarBanco"); // NOI18N
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(btnCriarBanco, javax.swing.GroupLayout.PREFERRED_SIZE, 48, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(20, 20, 20))
        );
    ...
    private void btnCadastrarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnCadastrarMouseClicked
        ...
        if(nome.isEmpty() || cpf.isEmpty() || telefone.isEmpty() || email.isEmpty() || rua.isEmpty() || numero.isEmpty() || cep.isEmpty() || login.isEmpty() || senha.isEmpty() || confSenha.isEmpty()){
            ...
            if(senha.equals(confSenha)){
                ...
                int id_endereco = u.buscarIdEndereco(clienteModel, enderecoModel);
                ...
                u.incluirCliente(clienteModel, enderecoModel);  
    ...
    private javax.swing.JToggleButton btnCriarBanco;
