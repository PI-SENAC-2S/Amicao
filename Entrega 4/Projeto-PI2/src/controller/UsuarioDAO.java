...
public class UsuarioDAO extends ConectarDAO{
    ...
    // Tabela Funcionário
    public void incluirFuncionario(funcionarioModel fm){
    ...
    // Puxar Cliente
    public int buscarIdCliente(clienteModel clM, usuarioModel usM){
        
        sql = "SELECT * FROM cliente WHERE id_usuario='"+ usM.getIdUsuario()+ "'";
    ...
    // Puxar Endereco
    public int buscarIdEndereco(clienteModel clM, enderecoModel enM){   
